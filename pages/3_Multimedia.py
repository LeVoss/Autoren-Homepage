...
st.set_page_config(page_title="Multimedia - Stefan Röser", page_icon="🎬", layout="centered")
...
with menu_col4:
    if st.button("🎬 Media", use_container_width=True, type="primary"): st.switch_page("pages/3_Multimedia.py")

st.divider()
st.write("<br>", unsafe_allow_html=True)

st.header("🎬 Multimedia & Einblicke")
st.write("<div style='font-size: 1.2em;'>In diesem Bereich entstehen bald visuelle und akustische Einblicke in meine Romane.</div>", unsafe_allow_html=True)

# Platzhalter für Marion
st.info("💡 *Muster-Eintrag für Marion:* Hier können wir später ganz einfach Buchtrailer (YouTube), Interviews oder sogar kleine Audio-Hörproben einbetten.")
